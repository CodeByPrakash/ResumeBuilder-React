...
export const ResumeSummaryCard = ({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)} // mouse or swiper for mobile view
    ...
    `} onClick={onSelect}>
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          <img src={thumbnailImg || '/placeholder.svg'} alt="Template preview thumbnail" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"/>
          ...
          {isSelected && (
            <div className="absolute inset-0 bg-violet-500/10 flex items-center justify-center">
              <div className="w-16 h-16 bg-white backdrop-blur-sm rounded-full flex items-center animate-pulse">
