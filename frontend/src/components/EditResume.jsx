...
import { dataURLtoFile } from '../utlis/helper';
...
export const EditResume = () => {
  ...
  // UPDATE THE ARRAY ITEM STATE USING INDEX
  ...
  // ADDING NEW ARRAY ITEM IE INFORMATION
  ...
  // REMOVING THE INFORMATION USING INDEX
 ...
 // THIS FUNCTION WILL HELP IN UPDATING RESUMES AND PUT WILL HELP IN UPDATION IN BACKEND
  ...
  // delete function to delete our any resume
  ...
  // HELP US IN DOWNLOADING THE RESUME IN PDF FORMAT  
  const downloadPDF = async () => {
    ...
    // TYPE OF HOW IT LOOK WHEN DOWNLOADING.
    try {
      await html2pdf()
        .set({
          margin:       0,
  ...
  // SO ALL THIS FUNCTIONS WILL BE USED FOR THE EDIT RESUME
  useEffect(() => {
    if (resumeId) {
      ...
      <div className={containerStyles.main}>
        <div className={containerStyles.header}>
          <TitleInput
            ...
            onSaveTitle={() => updateResumeTitle(resumeData.title)} // ✅ Save on tick click
          />
