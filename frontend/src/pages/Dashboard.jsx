...
import { LucideFilePlus, FilePlus, Trash2,  } from 'lucide-react';
    ...
    <DashboardLayout>
          ...
          <div className='flex gap-4'>
            <button className={styles.createButton} onClick={() => setOpenCreateModal(true)}>
              ...
              <span className={styles.createButtonContent}>
                Create Now
                <LucideFilePlus
                  className='group-hover:translate-x-1 transition-transform ease-in-out duration-200'
                  size={18}
                />
              </span>
            </button>
      ...
      hideHeader maxWidth="max-w-2xl">
        <div className='p-6'>
          ...
          showActionBtn actionBtnText='Delete' actionBtnIcon className='bg-red-600 hover:bg-red-700'
