                ...
                <div className={landingPageStyles.headerContainer}>
                    <div className={landingPageStyles.logoContainer}>
                        ...
                        <span className={landingPageStyles.logoText}>
                            Multimedia Resume Builder
                        </span>
                    </div>
                    {/* Moble Navigation Btn */}
                        ...
                        <div className={landingPageStyles.ctaCard}>
                            ...
                            <div className={landingPageStyles.ctaCardContent}>
                                <h2 className={landingPageStyles.ctaTitle}>
                                    Ready to Build Your 
                                    <span className={landingPageStyles.ctaTitleGradient}>Standout Resume?</span>
                                </h2>
            ...
            <footer className={landingPageStyles.footer}>
                <div className={landingPageStyles.footerContainer}>
                        <p className={landingPageStyles.footerText}>
                            ...
                            <a href="https://absoluteprakash.vercel.app/" target="_blank" className={landingPageStyles.footerLink}>Om Prakash Behera</a>
                        </p>
                </div>
            </footer>
